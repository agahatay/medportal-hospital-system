...
const DoctorRadiologicalResults = () => {
    const { user } = useAuth();
    ...
    return (
        <div>
            <div style={{ marginBottom: '2rem' }}>
                <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: 0 }}>Radiological Results</h1>
                <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                    Imaging studies and radiology findings for your patients.
                </p>
            </div>
                        ...
                        >
                            ...
                            <div style={{ padding: '1rem' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                                    <div style={{ fontWeight: 600, fontSize: '0.95rem' }}>{r.patient_name}</div>
...
export default DoctorRadiologicalResults;
